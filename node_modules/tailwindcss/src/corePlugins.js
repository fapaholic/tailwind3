...
export let variantPlugins = {
  ...
  darkVariants: ({ config, addVariant }) => {
    ...
    if (mode === 'selector') {
      ...
      // Old behaviorko fitxategi asko ezabatzen direnean",
  ...
  "kfmWindowLossAversionDialogBody": "Karpeta baten babeskopia egiteari uzten diozunean, fitxategi berriak zure gailuan soilik gordetzen dira; ez daude beste gailu batzuetan eskuragarri eta OneDrive-k ez ditu babetStyles = postcss.parse(
